...
class Interested implements Entity
{
    private $name;
     ...
     */
    public function __construct($name, $firstSurName, $secondSurName, $documentIdentifierType, $documentIdentifier, $bussinessName, $country, $province, $city, $postalCode, $address, $email, $telephone, Representative $representative)
    {
        $this->name = $name;
